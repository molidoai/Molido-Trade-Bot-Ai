...
def score_candles(candles: Sequence[Candle]) -> QualityReport:
    ...
    bad = 0
    hard_bad = 0  # physically impossible OHLC — always refuses to trade,
    # regardless of how well the rest of the window scores in aggregate.
    ...
    tradeable = hard_bad == 0 and score >= 0.85 and bad < 5
